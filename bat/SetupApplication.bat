...
:: Android packaging
set AND_CERT_NAME="Run Watermelon Run"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\RunWatermelonRun.p12
...
set IOS_PROVISION=cert\RunWatermelonRun.mobileprovision
...
set APP_ID=air.RunWatermelonRun

:: Output packages
set DIST_PATH=dist
set DIST_NAME=RunWatermelonRun
